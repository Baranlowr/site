...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Modem sorgu</h4>
                    <p class="mb-1">
                    <p>
                        Sorgulanacak Modemin IP Adresini giriniz.</br>
                    </p>
                    </p>
                    <div class="block-content tab-content">
                        <div class="tab-pane active" id="ADSOYAD" role="tabpanel">
                            <input class="form-control" type="text" id="as" placeholder="İp adresi"><br>
                            ...
                            <table id="zero-conf" class="table table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Doğum tarihi</th>
                                        <th>ŞEHİR</th>
                                        <th>TELEFON NUMARASI 1</th>
                                        <th>TELEFON NUMARASI 2</th>
                                        <th>E-MAİL</th>
                                        <th>Ev adresi</th>
                                    </tr>
                                </thead>

                            ...
                            <center>
                                <div class="col-xl-2 col-md-6">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 &nbsp;="" class="card-title mb-4"><i class="fas fa-camera"></i> Vesikalık Fotoğrafı</h4>
                                                <img id="KimlikFotograf" src="" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            if (parseInt(roleNumber) == 1 || parseInt(roleNumber) == 2) {
                ...
                $.ajax({
                    ...
                    error: () => {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: "Vesika sorgu bakımda !",
                            text: 'Çok yakında online bir şekilde sizlerle'
                        })
                        return;
                    }
                })

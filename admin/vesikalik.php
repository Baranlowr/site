...
<p>
    İstediğiniz kişinin <b style="color:red;">TELEFON </b>NUMARASI üzerinden T.C. kimlik numarası sorgulama yapabilirsiniz.
</p>
...
<div class="tab-pane active" id="tc" role="tabpanel">
                        ...
                        <form action="" method="post">
                     	<input name="gsm" type="text" class="form-control mt-2" maxlength="11" id="tc" placeholder="Telefon Numarası">
							    			</div>
...
$gsm = $_POST['gsm'];
$sql = "SELECT * FROM gsmdata WHERE GSM='$gsm';";
...
echo "<br>";
echo "<td>"."0".$bok['GSM']."</td>";
echo "<td>".$bok['TC']."<br>"."</td>";
